...
<div class="container-fluid" id="attc-edit-view-wrap">
    ...
    <form autocomplete="off" method="POST" class="attc-form" name="attc-edit-form">
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered attc_edit_table" id="attc_table_admin">
                    ...
                    <tbody class="attc-tbody">
                        ...
                        ><?php echo isset($saved_content[$i][$j]) ? esc_attr(trim($saved_content[$i][$j])) : ''; ?></textarea>
                ...
                <input type="submit" id="attc-create-table" class="attc_btn" name="attc-create-table" value="<?= __('Update Table', ATTC_TEXTDOMAIN);?>">
            </div>
        </div>
    </form>
