    ...
    function single_row_columns($item) {
        ...
        foreach ($columns as $column_name => $column_display_name) {
            ...
            elseif ('name' == $column_name) {
                ...
                echo sprintf('<a href="?page=%s&action=%s&table=%s">Edit</a>','create-table-page','edit',$item['ID']);
                echo "</span> | <span class='trash'>";
                echo sprintf('<a class="confirmation" href="?page=%s&action=%s&table=%s">Delete</a>',$_REQUEST['page'],'delete',$item['ID']);
                echo "</span></div></td>";
            }
            else {
                echo "<td $attributes>";
