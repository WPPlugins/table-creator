...
Tags: table, csv, xls, excel, data table, data, html table, html, csv file, csv-to-table, database table, import table, import csv data, table creator, table generator, table sorter, table builder, table filter, visualization, visualize data. data presentation, export table, export csv, easy table, wordpress table, wordpress data table, csv table, json table, json to table, responsive table, responsive data table, responsive html table
...
Table Creator plugin allows you to create interactive sortable big data tables as well as a simple table using a very clean and easy-to-use interface. 
...
So what makes this plugin the best data table creator plugins? 
...
3. Go to Settings menu under 'Table Creator' and create a table and use the shortcode generated eg. [attc id=1] on the top right side of the table editing page on any page or post where you would like to display the table. 
